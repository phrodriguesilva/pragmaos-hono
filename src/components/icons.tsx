...
export const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "doc-search", label: "Busca em Docs", href: "/search/documents", icon: "ph-file-magnifying-glass" },
  ...
  },
  {
    ...
    children: [
      ...
      { key: "jurimetria", label: "Jurimetria", href: "/jurimetria", icon: "ph-chart-scatter" },
  ...
  },
  {
    ...
    children: [
      ...
      { key: "workflows", label: "Workflows", href: "/workflows", icon: "ph-flow-arrow" },
