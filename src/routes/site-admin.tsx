      ...
      <form method="post" action="/site/appearance" class="space-y-6 mt-6">
        <Panel title="Identidade Visual" icon="ph-palette">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <TextField label="Cor Primaria" id="primary_color" name="primary_color" type="color" value={tenant.primary_color ?? "#0568ff"} />
            <TextField label="Cor Secundaria" id="secondary_color" name="secondary_color" type="color" value={tenant.secondary_color ?? "#4d8bff"} />
...
siteAdminRoutes.post("/appearance", async (c) => {
  ...
  const { error } = await supabase
    ...
    .update({
      ...
      primary_color: String(body.primary_color ?? "#0568ff"),
      secondary_color: String(body.secondary_color ?? "#4d8bff"),
