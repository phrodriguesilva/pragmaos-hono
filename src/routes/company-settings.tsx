          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="flex items-center gap-2">
                <input id="primary_color" name="primary_color" type="color" value={tenant?.primary_color ?? "#006382"} class="w-12 h-10 rounded cursor-pointer border border-gray-200" />
                <span class="text-body-sm text-gray-500">{tenant?.primary_color ?? "#006382"}</span>
              </div>
            </div>
            <div>
              <label for="secondary_color" class="text-body-sm font-semibold text-gray-700 mb-1 block">Cor secundaria</label>
              <div class="flex items-center gap-2">
                <input id="secondary_color" name="secondary_color" type="color" value={tenant?.secondary_color ?? "#00b3e6"} class="w-12 h-10 rounded cursor-pointer border border-gray-200" />
                <span class="text-body-sm text-gray-500">{tenant?.secondary_color ?? "#00b3e6"}</span>
              </div>
            </div>
          </div>
        </Panel>
