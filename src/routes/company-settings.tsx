          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div class="flex items-center gap-2">
                ...
                <span class="text-body-sm text-gray-500">{tenant?.primary_color ?? "#0568ff"}</span>
              </div>
            </div>
            <div>
              ...
              <div class="flex items-center gap-2">
                ...
                <span class="text-body-sm text-gray-500">{tenant?.secondary_color ?? "#4d8bff"}</span>
              </div>
            </div>
          </div>
        </Panel>
...
companySettingsRoutes.post("/", async (c) => {
  ...
  await supabase
    ...
    .update({
      ...
      primary_color: parsed.data.primary_color || "#0568ff",
      secondary_color: parsed.data.secondary_color || "#4d8bff",
      subdomain,
    })
    .eq("id", user.tenantId);
