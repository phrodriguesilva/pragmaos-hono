...
await $`bun build src/server/app.ts --outfile src/generated/bundle.js --target node --format esm --external @supabase/supabase-js --external hono --external isomorphic-dompurify --external jsdom`;
